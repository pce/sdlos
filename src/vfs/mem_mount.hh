...
// vfs/mem_mount.hh — IMount backed by an in-memory byte-map.
//
// Useful for:
//   - Embedded / ROM-like resources baked in at compile time
//   - Temporary / generated files that must not touch the real filesystem
//   - Caches and scratch buffers shared between subsystems
//   - Unit tests (seed data, verify reads without disk I/O)
//
// Directory model
// ───────────────

...
// AppCatalog.h — Registry of installed AppBundles.
//
// Single responsibility: track which applications are available to launch.
// No execution, no threads, no SDL, no window management.
//
...
//
// This separation means AppCatalog can be tested, serialised, and reasoned
// about in complete isolation from the rest of the system.
...
public:
    ...
    /// Returns true when a bundle with this name is installed.
    ...
    /// True when no bundles are installed.

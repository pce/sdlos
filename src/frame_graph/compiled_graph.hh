...
#include "pug_parser.hh"          // StyleMap, PassDesc — shared types
...
struct CompiledPass {
    ...
    [[nodiscard]] uint8_t find_slot(uint32_t key_hash) const noexcept {
...
struct CompiledGraph {
    ...
    // ── Cold path — CSS-driven mutations ───────────────────────────────────
    ...
    /// Dump pass states to stdout — useful during development.

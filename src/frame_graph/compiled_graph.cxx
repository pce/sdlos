// =============================================================================
// frame_graph/compiled_graph.cxx
//
// CompiledGraph — zero-overhead render pipeline execution.
//
// Hot path  (every frame):   execute()
// Cold path (CSS / events):  patch(), set_enabled(), apply_style()
// =============================================================================
...
// FNV-1a hash — identical to the one used in frame_graph.cxx.
// Kept here so compiled_graph.cxx compiles independently.
...
// =============================================================================
// CompiledGraph::set_enabled
//
// Enable or disable a pass by name.
// execute() skips disabled passes in O(1).
// =============================================================================
...
// =============================================================================
// CompiledGraph::apply_style
//
// Generic CSS property setter.  Dispatches to set_enabled() for the special
// "enabled" key, and to patch() (with string→float conversion) for all others.
//
// Called by the CSS integration layer for every property change on a pipeline
// node — same contract as RenderNode::setStyle().
// =============================================================================
...
// =============================================================================
// CompiledGraph::dump  —  diagnostics
// =============================================================================

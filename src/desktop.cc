 ...
 * @param w      Width in logical pixels
 * @param h      Opaque resource handle
 * @param flags  Bitmask of option flags
 *
...
void Desktop::buildDesktopScene()
{
    ...
    // TextBox
    //
    // TODO draw widgets load a scene instead of hardcoded dimensions;
    // the layout pass will make them responsive to viewport changes.  For now

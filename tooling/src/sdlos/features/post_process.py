...
============================
Post-processing pipeline for C++ source files produced by sdlos scaffolding
or found in the engine codebase.
...
def make_template_pipeline(
    *,
    ...
    Order: clang-format → SCA → docblocks → [metrics]
...
def make_engine_pipeline(
    *,
    ...
    """Build a full-featured pipeline for the engine source tree.

// ============================================================================
// jadearea.cxx — Jade Live Editor behaviour
// ============================================================================
//
...
#include "jade/jade_parser.hh"       // jade::parse()
#include "style_draw.hh"             // bindDrawCallbacks()
#include "widgets/input_text_box.hh" // TextArea / makeTextArea
                   ...
                   pce::sdlos::SDLRenderer& renderer)
{
    ...
    // They are visible here because this file is #include-d into jade_host.cxx.
    //
